...
// inclusion of the generated files (generated out of Solver.xml)
#include "SolverPy.h"
#include "SolverPy.cpp"

using namespace Sketcher3D;

PyObject *SolverPy::PyMake(struct _typeobject *, PyObject *, PyObject *)  // Python wrapper
{
    // create a new instance of Solver and the Twin object 
    return new SolverPy(new Solver);
}

// constructor method
int SolverPy::PyInit(PyObject* args, PyObject* /*kwd*/)
{/*
...
std::string SolverPy::representation(void) const
{/*
    std::stringstream result;
    result << "<Constraint " ;
    switch(this->getSolverPtr()->Type) {
...
PyObject *SolverPy::getCustomAttributes(const char* /*attr*/) const
{
    return 0;
}

int SolverPy::setCustomAttributes(const char* /*attr*/, PyObject* /*obj*/)
{
    return 0; 
}
