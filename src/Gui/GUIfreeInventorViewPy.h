...
#ifndef GUI_GUIFREEINVENTORVIEWPY_H
#define GUI_GUIFREEINVENTORVIEWPY_H
...
class GUIfreeInventorView;
class GUIfreeInventorViewer;

class GUIfreeInventorViewPy : public Py::PythonExtension<GUIfreeInventorViewPy>
{
public:
    static void init_type(void);    // announce properties and methods

    GUIfreeInventorViewPy(GUIfreeInventorView *vi);
    ~GUIfreeInventorViewPy();
...
private:
    ...
    GUIfreeInventorView* _view;
    friend class GUIfreeInventorView;
};

} // namespace Gui

#endif //GUI_GUIFREEINVENTORVIEWPY_H
