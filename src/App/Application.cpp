...
void Application::initTypes(void)
{
    ...
    App ::CrossCoordinateSystemPropertyLink       ::init();
    App ::PropertyLinkSub                         ::init();
    App ::CrossCoordinateSystemPropertyLinkSub    ::init();
    App ::PropertyLinkList                        ::init();
    App ::CrossCoordinateSystemPropertyLinkList   ::init();
    App ::PropertyLinkSubList                     ::init();
    App ::CrossCoordinateSystemPropertyLinkSubList::init();
